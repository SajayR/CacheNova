...
def chaos(prompt, session_id):
    ...
    subjectlink =  [{subject: imp.get_subjectlink(subject)} for subject in subjects]#returns a link to html file that contains only the relevant subjects
